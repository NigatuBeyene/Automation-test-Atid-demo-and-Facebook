...
def test_valid_registation_all_requerments_are_field_correctly():  # 1
...
def test_invalid_firstname_field_NONE_but_all_requerments_are_field_correctly():  # 2
    driver = webdriver.Chrome()
    driver.get(facebookWebsite)
    driver.find_element(By.XPATH, creat_new_account).click()
    sleep(3)
...
def test_invalid_lastname_field_NONE_but_all_requerments_are_field_correctly():  # 3
    driver = webdriver.Chrome()
    driver.get(facebookWebsite)
    driver.find_element(By.XPATH, creat_new_account).click()
    sleep(3)
...
def test_invalid_all_requerments_are_field_correctly_exept_incorrect_phone_number():  # 4
    driver = webdriver.Chrome()
    driver.get(facebookWebsite)
    driver.find_element(By.XPATH, creat_new_account).click()
    sleep(3)
...
def test_invalid_all_requerments_are_field_correctly_exept_invalid_bith_date():  # 5
    driver = webdriver.Chrome()
    driver.get(facebookWebsite)
    driver.find_element(By.XPATH, creat_new_account).click()
    sleep(3)
...
def test_valid_registation_all_requerments_are_field_correctly_exept_fistname_and_lastname_field_are_NONE():  # 6
    driver = webdriver.Chrome()
    driver.get(facebookWebsite)
    driver.find_element(By.XPATH, creat_new_account).click()
    sleep(3)
...
def test_invalid_registation_all_requerments_are_field_correctly_exept_fistname_field_NONE_and_invalid_password():  # 7
    driver = webdriver.Chrome()
    driver.get(facebookWebsite)
    driver.find_element(By.XPATH, creat_new_account).click()
    sleep(3)
